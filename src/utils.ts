...
export const translations: Record<string, Record<Language, string>> = {
  ...
  take_photo: { en: 'Take Photo', ro: 'Fotografiază' },
  ...
  delete_account_confirm_title: { en: 'Delete Account?', ro: 'Ștergi Contul?' },
  delete_account_confirm_body: { en: 'Are you sure you want to delete your account? All data (transactions, profile, settings) will be permanently lost. This action cannot be undone.', ro: 'Ești sigur că vrei să ștergi contul? Toate datele (tranzacții, profil, setări) vor fi pierdute definitiv. Această acțiune este ireversibilă.' },
