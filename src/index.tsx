...
function App() {
  ...
  const handleUpdateTransaction = async (updatedTx: Transaction) => {
    // Re-use the central `appTransactionToDb` data mapper for consistency. This ensures
    // that the data structure sent to the database is always correct and matches the
    // structure used when creating new transactions, resolving the schema error.
    const dbPayload = appTransactionToDb(updatedTx);
    
    // The user_id should not be part of an update payload. We remove it here.
