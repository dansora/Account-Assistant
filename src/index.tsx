...
type Transaction = {
  id: number; // Supabase uses a number for the primary key by default
  created_at: string;
  type: 'income' | 'expense';
  amount: number;
...
function App() {
  ...
  // Fetch transactions from Supabase on initial load
  useEffect(() => {
  ...
  const renderPage = () => {
    if (loading) {
      return <div className="page-content"><p>Loading data...</p></div>;
    }
